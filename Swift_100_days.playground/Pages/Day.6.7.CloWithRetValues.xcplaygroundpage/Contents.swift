// Usar cierres como parametros cuando devuelven valores
...
// Ahora, cuando llamamos travel() usando la sintaxis de cierre final, se requiere que nuestro codigo de cierre acepte una cadena y devuelva una cadena
