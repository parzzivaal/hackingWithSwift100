//Day 9.3 Lazy Properties
//Como optimización del rendimiento, Swift le permite crear algunas propiedades solo cuando son necesarias. Como ejemplo, considere esta FamilyTreeestructura: no hace mucho, pero en teoría crear un árbol genealógico para alguien lleva mucho tiempo:struct FamilyTree {
init() {
